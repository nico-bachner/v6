...
[Make® Conversations](https://make.dk/conversations/) is a web-based project I worked on during my time as a student developer at [Make®](https://make.dk), a creative consultancy based in Copenhagen.
...
One of the biggest contributions I made was to the performance of the site. Loading speed is a metric which is critical for a great user experience. Through the use of modern technologies, I was able to improve the Time To Interactive (TTI) of the site by a factor of 4 when compared to its predecessor.[^1]

Another big impact I had was on the subject of accessibility (a11y). While the changes were mostly small and easy to make, such as fixing previously blocked visual scaling, they can potentially have a huge impact on visitors of the site who rely on these features to navigate it.
...
[^1]: Metrics measured using [Google Lighthouse](https://developers.google.com/web/tools/lighthouse/). TTI decreased from 11.1s to 2.4s.

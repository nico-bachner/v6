...
export const title = 'The First Martian'
export const description = 'An Indie Space Exploration Game'
export const from = '2018-09-01'
export const to = '2019-02-01'
...
The game bears a certain similarity to _Thrust_, a 1986 video game. The objective is to navigate a spaceship from the launch platform to the landing platform. The first level starts out simple, with only one rock to navigate around.
